...
<div class="content-wrapper">
    <section class="content-header">
        <h1><?php echo app('translator')->getFromJson('site.subCategories'); ?></h1>
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo app('translator')->getFromJson('site.subCategories'); ?></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title" style="margin-bottom: 15px"><?php echo app('translator')->getFromJson('site.subCategories'); ?>
                    <small>
                        <?php echo app('translator')->getFromJson('site.total_search'); ?>
                        ( <?php echo e($subCategories->count()); ?> )
                    </small></h3>
                <form action="<?php echo e(route('dashboard.subCategories.index')); ?>" method="get">
                    <div class="row">
                        <div class="<?php echo e($subCategory_search=='close'?'hidden':''); ?>">
                            <div class="col-md-4">
                        ...
                        <div class="col-md-4 <?php echo e($subCategory_add=='close'?'hidden':''); ?>">
                            <?php if(auth()->user()->hasPermission('create_subCategories')): ?>
                            <a href="<?php echo e(route('dashboard.subCategories.create')); ?>" class="btn btn-primary"><i
            ...
            <div class="box-body">
                ...
                <table class="table table-hover" id="data_table">
                    <thead>
                        <tr>
                            <th> </th>
                            <th><?php echo app('translator')->getFromJson('site.categories'); ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="<?php echo e($subCategory->image_path); ?>" style="width: 100px;" class="img-thumbnail" alt="">
                            </td>
                            <td>
                                <?php if(auth()->user()->hasPermission('update_subCategories')): ?>
                                    <a href="<?php echo e(route('dashboard.subCategories.duplicate', $subCategory->id)); ?>"
                                    class="btn btn-warning btn-sm <?php echo e($subCategory_edit=='close'?'hidden':''); ?>"><i
                                        class="fa fa-copy"></i> <?php echo app('translator')->getFromJson('site.duplicate'); ?></a>

                                <a href="<?php echo e(route('dashboard.subCategories.edit', $subCategory->id)); ?>"
                                    class="btn btn-info btn-sm <?php echo e($subCategory_edit=='close'?'hidden':''); ?>"><i
                                ...
                                <?php endif; ?>
                                <?php if(auth()->user()->hasPermission('delete_subCategories')): ?>
                                <form action="<?php echo e(route('dashboard.subCategories.destroy', $subCategory->id)); ?>" method="post"
                                    ...
                                    <button type="submit"
                                        class="btn btn-danger delete btn-sm <?php echo e($subCategory_delete=='close'?'hidden':''); ?>"><i
