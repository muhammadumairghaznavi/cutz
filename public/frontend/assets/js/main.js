...
$(document).ready(function() {
    ...
    $(document).mouseup((e) => {
        if (!$(".menu-logins").is(e.target) && // if the target of the click isn't the container...
    ...
    $(document).mouseup((e) => {
        if (!$(".menu-cart").is(e.target) && // if the target of the click isn't the container...
    ...
    $(document).mouseup((e) => {
        if (!$(".form-search-header").is(e.target) && // if the target of the click isn't the container...
