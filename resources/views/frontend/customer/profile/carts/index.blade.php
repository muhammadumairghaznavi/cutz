                            ...
                            <tr id="{{ $cart->id }}">
                                ...
                                <td>
                                    <div class="min-add-button d-flex align-items-center">
                                        ...
                                        <input type="text" name="" class="adults" size="10" value="{{ $cart->qty }}">
                                        <a href="#" class="input-group-addon plus increment add"><i class="fas fa-arrow-up"
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td class="text-right" colspan="2">
                                <a onclick="update_cart()" class="btn-checkout btn_to_update my-4"><i
                                        class="fas fa-sync"></i> Update Cart</a>

                            </td>
                            <td class="text-right" colspan="1">
                                <a href="{{ route('customer.checkout.index') }}"
                                    class="btn-checkout btn_to_chout my-4">@lang('site.checkout')</a>
                            </td>
                        </tr>
                    </tfoot>
