                    ...
                    <form action="{{ route('dashboard.products.index') }}" method="get">
                        <div class="row">
                            ...
                            <div class="col-md-4 {{ $section_add == 'close' ? 'hidden' : '' }}">
                                ...
                                <a href="{{ route('dashboard.products.export') }}" class="btn btn-primary"><i
                                        class="fa fa-plus"></i>
                                    @lang('site.export')</a>
                                        ...
                                        <td>
                                            ...
                                            @if ($product->measr_unit == 'byGram' || $product->measr_unit == 'byKilogram')
                                                ...
                                                @foreach ($productWeights as $index => $productWeight)
                                                    ...
                                                    {{ $productWeight->price }} L.E
                                                    <br>
                                                @endforeach

                                            @else
                                                {{ $product->Total }} {{ __('site.' . currncy()) }}/
                                                {{ $product->unitValue }}-{{ $product->measr_unit }}<br />
                                                @if ($product->discount)

                                                    @lang('site.discounted') : {{ $product->discount }}
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right"
                                                    ...
                                                    <li>
                                                        <a style="display: inline-block"
                                                            href="{{ route('dashboard.productLocations.index', [
    'product_id' => $product->id,
]) }}"
                                                            class="danger btn-sm {{ $productLocation_edit == 'close' ? 'hidden' : '' }}"><i
                                                                class="fa fa-cock"></i>
                                                            {{ $product->productLocation->count() }}
                                                            @lang('site.productLocations')</a>
                                                    </li>
                                                    <li>
                                                        <a style="display: inline-block"
                                                            href="{{ route('dashboard.instructions.index', [
    'product_id' => $product->id,
]) }}"
                                                            class="danger btn-sm {{ $section_edit == 'close' ? 'hidden' : '' }}"><i
                                                                class="fa fa-cock"></i>
                                                            {{ $product->instructions->count() }}
                                                    ...
                                                    <li>
                                                        <a href="{{ route('dashboard.additions.index', ['product_id' => $product->id]) }}"
                                                            ...
                                                            {{ $product->additions->count() }} additions
                                                        </a>
                                                    </li>
                                                    <li>
