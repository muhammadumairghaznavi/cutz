    ...
    <section class="content">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form action="{{ route('dashboard.additions.update', $addition->id) }}" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <select name="product_id" id="" class="form-control">
                            ...
                            <option {{$item->id==$addition->product_id?'selected':''}} value="{{$item->id}}">
                                {{$item->title}}</option>
                            @endforeach
                        </select>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="title_en" class="form-control" value="{{$addition->title_en}}">
                    </div>
                    <div class="form-group">

                        <label>@lang('site.title_addition_ar')</label>
                        <input type="text" name="title_ar" class="form-control" value="{{$addition->title_ar}}">
                    </div>
                    <div class=" form-group  ">
                      ...
                      {{-- <div class=" form-group  ">
                        ...
                        <span class="is-invalid alert-danger" role="alert">
