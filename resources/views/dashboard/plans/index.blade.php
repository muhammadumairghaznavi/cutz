    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title" style="margin-bottom: 15px">@lang('site.plans')
                    <small>
                ...
                <table class="table table-hover" id="data_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @lang('site.price_egy') :
                                     {{ $plan->scope_price_egy }} @lang('site.currency_egy')   <br> @lang('site.dicount') <del> {{ $plan->scope_egy_discount }}  @lang('site.currency_egy')    </del>
                                <br>
                                @lang('site.price_usd') :
                                     {{ $plan->scope_price_usd }} @lang('site.currency_dollar')    <br> @lang('site.dicount') <del> {{ $plan->scope_usd_discount }} @lang('site.currency_dollar')   </del>
                                <br>
                            </td>
                            <td>
                                {{$plan->time_period}}
                            ...
                            {{-- <td><img src="{{ $plan->image_path }}" style="width: 100px;" class="img-thumbnail" alt="">
                            </td> --}}
                            <td>
                                @if (auth()->user()->hasPermission('update_plans'))
                                 <a href="{{ route('dashboard.plans.duplicate', $plan->id) }}"
