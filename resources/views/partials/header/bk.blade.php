...
\Log::info( authcustomer()->full_name  );
...
<div class="right-header d-flex align-items-center">
  <div class="actions-mobile d-flex align-items-center">
          ...
          <li class="scroll-y">
            ...
            <div class="item">
              ...
              <div class="txt">
                ...
                <p class="qty"> @lang('site.price') ={{$cart->type?$cart->product->Total *(int)($cart->type) /1000: $cart->product->Total}}</p>
    ...
    <div class="langs d-none">
      ...
      <a rel="alternate" class="langs" hreflang="ar" data-toggle="tooltip" data-placement="bottom" title="English"
