    ...
    <div class="container">
        ...
        <div class="slides-related owl-carousel owl-theme">
            ...
            <div class="item-product">
                <div class="img">
                    <a href="{{route('product_details',['id'=>$item->id,'slug'=>make_slug($item->title)])}}"><img
                ...
                <div class="rating">
                    @for($star=1 ; $star<=$item->AvgRate;$star ++)
                        ...
                        @endfor
                        @for($star_off=$item->AvgRate ; $star_off< 5 ;$star_off++) <i class="fas fa-sm fa-star"></i>
                            @endfor
    ...
    <div class="container-fluid">
        <div class="row no-gutters">
            ...
            <div class="col-md-6 d-flex align-items-center justify-content-center hvh-100">
                <div class="txt">
                    <strong class="h1 d-block">
                        Wide range of <span>seafood varieties</span> from the best spots all over the world to your dining table.
                    </strong>
                    <!--<ul>-->
            ...
            @foreach ($categories as $item)
              <div class="col-lg-3 col-md-4 col-6">
                {{-- <a href="{{route('subCategories',['id'=>$item->id,'title'=>make_slug($item->title)])}}" --}}
                       <a href="{{ route('search',['category_id'=>$item->id]) }}"
                    class="catgss-item">
                    <div class="img">
