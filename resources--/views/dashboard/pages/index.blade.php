    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title" style="margin-bottom: 15px">@lang('site.pages')
                    <small>
            ...
            <div class="box-body">
                ...
                <table class="table table-hover" id="data_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <td> {{ __('site.'.$page->type) }}</td>
                            <td> {{ $page->title }}</td>
                            {{-- <td> {{ $page->description }}</td> --}}
                            <td><img src="{{ $page->image_path }}" style="width: 100px;" class="img-thumbnail" alt="">
                            </td>
                            <td>
                                @if (auth()->user()->hasPermission('update_pages'))
                                <a href="{{ route('dashboard.pages.duplicate', $page->id) }}"
