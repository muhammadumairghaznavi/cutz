                    ...
                    <form action="{{ route('dashboard.services.store') }}"  method="post" enctype="multipart/form-data">
                        ...
                        @foreach (config('translatable.locales') as $key=>$locale)
                            ...
                            <div class="form-group">
                              ...
                              <textarea required="required"  name="{{ $locale }}[short_description]" id="" class="form-control  " cols="30" rows="5">{{ old($locale . '.short_description') }}</textarea>
                            </div>
                            <div class="form-group">
                        ...
                        <article>
                            ...
                            <input type="file" multiple name="images[]" class="form-control" id="gallery-photo-add">
